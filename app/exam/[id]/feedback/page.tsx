...
const Feedback = async ({ params }: RouteParams) => {
  ...
  return (
    <>
      ...
      <div className="home-bg pt-16">
        <section className="section-feedback bg-stone-900/50 px-4 lg:px-8 py-3 lg:py-8 rounded-3xl mt-5">
          ...
          <div className="flex flex-col gap-5">
            <h2 className="text-orange-200">Breakdown of the Interview:</h2>
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-orange-200">Strengths:</h3>
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-orange-200">Areas for Improvement:</h3>
            <ul className="md:ml-6">
